        ...
        <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-10">
          ...
          <div className="px-2 md:px-0">
            ...
            <p className="mt-6 text-base md:text-lg text-muted-foreground max-w-prose">
              We make travel effortless by bringing everything you need to one
              place — stays, food, vehicles, permits, and local insights.
              Explore authentic experiences across the NorthEast with curated
