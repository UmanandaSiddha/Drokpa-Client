...
const DestinationsCarousel: React.FC = () => {
    ...
    const goToPrevious = () => {
        const next = currentIndex === 0 ? destinations.length - 1 : currentIndex - 1;
    ...
    return (
        <section className="w-full py-12 lg:py-16 relative overflow-hidden bg-linear-to-b from-white via-[rgba(0,82,70,0.06)] to-white">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-16 lg:mb-24">
                ...
                {/* Carousel */}
                <div className="relative" onMouseMove={onMouseMove} onMouseLeave={onMouseLeaveWrapper}>
                    ...
                    <button
                        ...
                        className="absolute left-2 sm:left-4 top-1/2 -translate-y-1/2 text-white transition-transform duration-300 hover:scale-125 z-10 opacity-100 pointer-events-auto"
                    ...
                    <button
                        onClick={goToNext}
                        className="absolute right-2 sm:right-4 top-1/2 -translate-y-1/2 text-white transition-transform duration-300 hover:scale-125 z-10 opacity-100 pointer-events-auto"
                        aria-label="Next destination"
                    >
                        <span className="bg-black/40 p-2 rounded-full inline-flex">
                            <ChevronRight className="w-6 h-6 sm:w-7 sm:h-7 text-white" strokeWidth={2.5} />
                        </span>
                    </button>
...
const Slide: React.FC<SlideProps> = ({ destination, onHoverStart, onHoverEnd }) => {
    ...
    return (
        ...
        >
            <div className="relative h-[400px] sm:h-[500px] lg:h-[600px] overflow-hidden rounded-2xl bg-[#05231e]">
                <img
            ...
            >
                <div className="max-w-2xl">
                    ...
                    <div className={`${showDescription ? 'max-h-[800px] opacity-100 translate-y-0' : 'max-h-0 opacity-0 translate-y-3'} group-hover:max-h-[800px] group-hover:opacity-100 group-hover:translate-y-0 overflow-hidden transition-all duration-700 ease-in-out`}>
                        <div className={`${showDescription ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-3'} group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-700 ease-in-out flex flex-wrap items-center gap-3 sm:gap-4 mb-3 sm:mb-4`}>
                        ...
                        <div className={`${showDescription ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-3'} group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-700 ease-in-out flex flex-wrap gap-1 sm:gap-2 mb-4 sm:mb-6`}>
                        ...
                        <button className={`${showDescription ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-3'} group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-700 ease-in-out bg-white text-(--brand-green) font-bold px-4 sm:px-6 py-2 sm:py-3 rounded-full hover:bg-gray-100 transform hover:scale-105 shadow-lg text-sm sm:text-base`}>
                            Explore Now
                        </button>
                    </div>
                </div>
